<?php
/**
 * @var \codexten\yii\cron\models\Task $task
 * @var array $methods
 */
...
<div class="col-lg-6">
    ...
    <?= $form->field($task, 'status')->dropDownList([
        \codexten\yii\cron\TaskInterface::TASK_STATUS_ACTIVE => 'Active',
        \codexten\yii\cron\TaskInterface::TASK_STATUS_INACTIVE => 'Inactive',
        \codexten\yii\cron\TaskInterface::TASK_STATUS_DELETED => 'Deleted',
    ]) ?>
